...
export default function FloatingNavigation() {
  ...
  return (
    <>
      <nav className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 glassmorphism-card rounded-full px-8 py-4 transition-all duration-300 ${isScrolled ? 'bg-opacity-95' : ''}`}>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="fixed top-20 left-1/2 transform -translate-x-1/2 glassmorphism-card rounded-2xl p-6 w-64">
