...
export default function AboutSection() {
  return (
    <section id="about" className="py-12 md:py-24 px-4 md:px-6 bg-gradient-to-b from-white to-[var(--dark-bg)] min-h-screen relative z-10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="animate-fade-in-up">
            ...
            <h2 className="font-orbitron font-black text-2xl md:text-4xl lg:text-6xl mb-6 md:mb-8 ultra-premium-text text-glow leading-tight">
              We are the leading service provider in vehicle diagnosis and supply of automotive sensors.
            </h2>
            
            <p className="text-lg md:text-xl text-white/95 mb-6 md:mb-8 leading-relaxed font-light">
            ...
            {/* Enhanced Statistics */}
            <div className="grid grid-cols-3 gap-3 md:gap-6 mb-6 md:mb-8 p-4 md:p-6 glassmorphism rounded-2xl">
              <div className="text-center group hover:scale-110 transition-transform duration-300">
                <div className="text-xl md:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-1 md:mb-2 group-hover:text-[var(--brand-gold)] transition-colors">7+</div>
                <div className="text-xs text-white/80 uppercase tracking-wider font-semibold">Years Experience</div>
              </div>
              <div className="text-center group hover:scale-110 transition-transform duration-300">
                <div className="text-xl md:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-1 md:mb-2 group-hover:text-[var(--brand-gold)] transition-colors">1000+</div>
                <div className="text-xs text-white/80 uppercase tracking-wider font-semibold">Happy Clients</div>
              </div>
              <div className="text-center group hover:scale-110 transition-transform duration-300">
                <div className="text-xl md:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-1 md:mb-2 group-hover:text-[var(--brand-gold)] transition-colors">24/7</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-12 md:mt-20">
          <Card className="premium-card border-none group hover:transform hover:scale-105 transition-all duration-500">
            <CardContent className="p-6 md:p-10 text-center relative overflow-hidden">
              ...
              <h3 className="ultra-premium-text font-orbitron font-black text-xl md:text-3xl mb-4 md:mb-6 group-hover:text-[var(--brand-gold)] transition-colors duration-300">Our Mission</h3>
          ...
          <Card className="premium-card border-none group hover:transform hover:scale-105 transition-all duration-500">
            <CardContent className="p-10 text-center relative overflow-hidden">
              ...
              <h3 className="ultra-premium-text font-orbitron font-black text-xl md:text-3xl mb-4 md:mb-6 group-hover:text-[var(--brand-gold)] transition-colors duration-300">Our Vision</h3>
              <p className="text-white/95 leading-relaxed text-base md:text-lg font-light">
        ...
        <div className="mt-12 md:mt-20">
          <div className="text-center mb-12 md:mb-16">
            <h3 className="font-orbitron font-black text-2xl md:text-4xl lg:text-5xl ultra-premium-text mb-4 md:mb-6">Our Core Values</h3>
        ...
        <div className="mt-12 md:mt-20">
          <div className="text-center mb-12 md:mb-16">
            <h3 className="font-orbitron font-black text-2xl md:text-4xl lg:text-5xl ultra-premium-text mb-4 md:mb-6">Leadership Team</h3>
          ...
          <div className="glassmorphism rounded-3xl p-6 md:p-12 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-2">15+</div>
                  <div className="text-xs md:text-sm text-white/80 uppercase tracking-wider">Years Combined Experience</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-2">100+</div>
                  <div className="text-xs md:text-sm text-white/80 uppercase tracking-wider">Training Certifications</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-2">2</div>
