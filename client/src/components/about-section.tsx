      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 glassmorphism rounded-full px-4 md:px-6 py-3 mb-6 md:mb-8 neon-glow">
            ...
            <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
              {[
                ...
                <div key={index} className="flex items-center space-x-3 md:space-x-4 group animate-fade-in hover:transform hover:translate-x-2 md:hover:translate-x-4 transition-all duration-300" style={{animationDelay: `${index * 0.1}s`}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-12 md:mt-16 lg:mt-20">
          <Card className="premium-card border-none group hover:transform hover:scale-105 transition-all duration-500">
            <CardContent className="p-6 md:p-8 lg:p-10 text-center relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[var(--brand-orange)] to-orange-500"></div>
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 md:mb-8 rounded-3xl bg-gradient-to-r from-[var(--brand-orange)] via-orange-500 to-red-500 flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                <Target className="text-white group-hover:animate-pulse" size={28} />
              </div>
              <h3 className="ultra-premium-text font-orbitron font-black text-xl md:text-2xl lg:text-3xl mb-4 md:mb-6 group-hover:text-[var(--brand-gold)] transition-colors duration-300">Our Mission</h3>
              <p className="text-white/95 leading-relaxed text-sm md:text-base lg:text-lg font-light">
          ...
          <Card className="premium-card border-none group hover:transform hover:scale-105 transition-all duration-500">
            <CardContent className="p-6 md:p-8 lg:p-10 text-center relative overflow-hidden">
              ...
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-6 md:mb-8 rounded-3xl bg-gradient-to-r from-[var(--brand-blue)] via-blue-500 to-[var(--brand-gold)] flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                <Award className="text-white group-hover:animate-pulse" size={28} />
              </div>
              <h3 className="ultra-premium-text font-orbitron font-black text-xl md:text-2xl lg:text-3xl mb-4 md:mb-6 group-hover:text-[var(--brand-gold)] transition-colors duration-300">Our Vision</h3>
              <p className="text-white/95 leading-relaxed text-sm md:text-base lg:text-lg font-light">
        ...
        <div className="mt-12 md:mt-16 lg:mt-20">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            <h3 className="font-orbitron font-black text-2xl md:text-3xl lg:text-4xl xl:text-5xl ultra-premium-text mb-4 md:mb-6">Our Core Values</h3>
            ...
            {[
              ...
              <Card key={index} className="glassmorphism border-none group hover:transform hover:scale-105 transition-all duration-500">
                <CardContent className="p-4 md:p-6 lg:p-8 text-center">
                  <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 rounded-2xl bg-gradient-to-r from-[var(--brand-orange)] to-[var(--brand-blue)] flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                    <value.icon className="text-white group-hover:animate-pulse" size={20} />
                  </div>
                  <h4 className="font-orbitron font-bold text-lg md:text-xl text-white mb-3 md:mb-4 group-hover:text-[var(--brand-orange)] transition-colors">{value.title}</h4>
                  <p className="text-white/80 text-xs md:text-sm leading-relaxed">{value.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="mt-12 md:mt-16 lg:mt-20">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            <h3 className="font-orbitron font-black text-2xl md:text-3xl lg:text-4xl xl:text-5xl ultra-premium-text mb-4 md:mb-6">Leadership Team</h3>
            <div className="w-24 h-1 bg-gradient-to-r from-[var(--brand-orange)] to-[var(--brand-blue)] mx-auto mb-4 md:mb-6"></div>
          ...
          <div className="glassmorphism rounded-3xl p-6 md:p-8 lg:p-12 text-center">
            <div className="max-w-4xl mx-auto">
              <h4 className="font-orbitron font-bold text-xl md:text-2xl text-[var(--brand-orange)] mb-4 md:mb-6">Expert Leadership</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-2">15+</div>
                  <div className="text-xs md:text-sm text-white/80 uppercase tracking-wider">Years Combined Experience</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-2">100+</div>
                  <div className="text-xs md:text-sm text-white/80 uppercase tracking-wider">Training Certifications</div>
                </div>
                <div className="text-center">
                  <div className="text-xl md:text-2xl lg:text-3xl font-orbitron font-black text-[var(--brand-orange)] mb-2">2</div>
                  <div className="text-xs md:text-sm text-white/80 uppercase tracking-wider">Branch Locations</div>
                </div>
              </div>
            </div>
          </div>
